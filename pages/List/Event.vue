      ...
      <v-row>
            ...
            <v-row align="end" class="fill-height">
              ...
              <v-col class="py-0">
                <v-list-item color="rgba(0, 0, 0, .4)">
                  <v-list-item-content>
                    <v-list-item-title class="font-weight-bold title" style="color: #00ACC1">
                      AKI
                    </v-list-item-title>
        ...
        <v-col cols="10">
            ...
            <v-row>
              ...
              <v-col cols="10">
                <v-list-item three-line>
                  <v-list-item-content>
                    <div class="headline mb-3 font-weight-bold" style="color: #00ACC1;" @click="$router.push('/personal/personalevent')">John</div>
                    <div class="overline mb-1">10月18日</div>
                    <p class="mb-5">ロンドンを綺麗にしましょう。</p>
                  </v-list-item-content>
          ...
          <v-card class="mx-auto" outlined>
            <v-list-item three-line>
              <v-list-item-content>
                <div class="headline mb-3 font-weight-bold" style="color: #00ACC1;">John</div>
                <div class="overline mb-1">10月18日</div>
                <p class="mb-5">ロンドンを綺麗にしましょう。</p>
              </v-list-item-content>
